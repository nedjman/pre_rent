...
class TypeFacturation extends StatefulWidget {
  const TypeFacturation({super.key});

  @override
  State<TypeFacturation> createState() => _TypeFacturationState();
}

class _TypeFacturationState extends State<TypeFacturation> {
    ...
    return Scaffold(
      appBar: AppBar(
        ...
        title: Text(isMultiSelectionEnabled
            ...
            : "Sélectionnez les points forts de votre logement", style: TextStyle(fontSize:17),),
        actions: [
          Visibility(
